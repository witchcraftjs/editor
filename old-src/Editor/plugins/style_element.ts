...
export function style_element(container: {left?: number, top?: number} | HTMLElement, rect: Rect, el?: HTMLElement): Rect {
	let _ = { ...rect }
	let offset = container instanceof Element ? container.getBoundingClientRect() : container
