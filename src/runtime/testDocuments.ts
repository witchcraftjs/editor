...
<li><p>Image</p></li>
<!-- NOTE: While this should render exactly the same (demo injected file view uses same display method), to truly test the default image rendering without custom component, comment out the fileViewInjectionKey provide in EditorDemoApp.vue and use a plain <img src="..."/> -->
<li><div type="file" data-id="demo-image"/></li>
<li><div type="file" data-id="text-file-demo" data-ignore-aspect-on-resize="true"/></li>
${contentSimpleTable}
${someDoc.embedder}
