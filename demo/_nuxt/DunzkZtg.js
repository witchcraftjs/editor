import{W as y,aI as V,aW as r,aX as c,aY as u,aZ as D,I as A,j as L,r as z,o as F,v as g,O as m,x as h,R as p,y as d,S as v,P as w,N as a,A as b,L as E,B as x,a0 as O,a_ as I,aF as M,z as $,ah as R,ag as H,a8 as W,aj as K,Q as q,T as N,V as X}from"./C3NUVL-0.js";import{c as Y}from"./CD0Jx8XC.js";import C from"./g0bzUm99.js";function J(){const i=y({});function e(t,o){return i[t]=o,i[t]}return{slotVars:i,setSlotVar:e}}class S{timeout=5e3;debug=!1;id=0;queue;history;maxHistory=100;listeners=[];stringifier;constructor({timeout:e,stringifier:t,maxHistory:o}={}){this.queue=y([]),this.history=y([]),e&&(this.timeout=e),o&&(this.maxHistory=o),t&&(this.stringifier=t)}_checkEntry(e){if(e.cancellable!==void 0&&V(e.cancellable))throw new Error(u`Cancellable cannot be a blank string:
					${r(c(e),5)}
