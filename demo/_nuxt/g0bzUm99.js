import{I as g,j as k,v as l,x as i,R as d,S as c,T as b,N as r,P as u,Q as v,y as x,O as f,aI as w,z as y}from"./C3NUVL-0.js";import{u as m}from"./7IwD4oGN.js";import{g as B}from"./CUphBgkF.js";const q=["id","type","disabled","data-border","data-color","aria-disabled"],$=["id"],S={key:0},T=Object.assign({name:"LibButton"},{__name:"WButton",props:{id:{type:String,required:!1},label:{type:String,required:!1,default:""},disabled:{type:Boolean,required:!1,default:!1},readonly:{type:Boolean,required:!1,default:!1},border:{type:Boolean,required:!1,default:!0},unstyle:{type:Boolean,required:!1,default:!1},color:{type:[String,Boolean],required:!1,default:!1},autoTitleFromAria:{type:Boolean,required:!1}},setup(e){const a=g(),t=B(),n=e,s=m(n,t),h=k(()=>({title:n.autoTitleFromAria?a["aria-label"]??n.label:void 0}));return(o,j)=>(i(),l("button",u({id:e.id??r(t),class:!r(a).unstyle&&r(v)(`
		button
		flex
		cursor-pointer
		items-center
