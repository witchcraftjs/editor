import{i as g}from"./BhoX2VZY.js";import{u as k}from"./DB0SWIft.js";import{a as u}from"./9cslYIr4.js";import{g as v}from"./CRo8hmbH.js";import{a1 as f,p as x,c as l,H as d,R as i,S as c,q as r,D as w,o as b,a as m,E as y,t as B}from"./ChiTXbtN.js";const q=["id","type","disabled","data-border","data-color","aria-disabled"],$=["id"],S={key:0},D=Object.assign({name:"LibButton"},{__name:"WButton",props:{id:{type:String,required:!1},label:{type:String,required:!1,default:""},disabled:{type:Boolean,required:!1,default:!1},readonly:{type:Boolean,required:!1,default:!1},border:{type:Boolean,required:!1,default:!0},unstyle:{type:Boolean,required:!1,default:!1},color:{type:[String,Boolean],required:!1,default:!1},autoTitleFromAria:{type:Boolean,required:!1}},setup(e){const a=f(),t=v(),n=e,s=k(n,t),h=x(()=>({title:n.autoTitleFromAria?a["aria-label"]??n.label:void 0}));return(o,j)=>(b(),l("button",w({id:e.id??r(t),class:!r(a).unstyle&&r(u)(`
		button
		flex
		cursor-pointer
		items-center
	...
	`,!e.color&&"active:text-neutral-800",e.border&&`
		...
		`,r(a)?.class),type:r(a).type,tabindex:0,disabled:e.disabled,"data-border":e.border,"data-color":e.color,"aria-disabled":e.disabled},{...h.value,...r(a),class:void 0,...r(s)}),[d(o.$slots,"label",i(c({id:`label-${e.id??r(t)}`,classes:"button--label pointer-events-none flex flex-1 items-center justify-center gap-1"})),()=>[m("label",{id:`label-${e.id??r(t)}`,class:"button--label pointer-events-none flex flex-1 items-center justify-center gap-1"},[d(o.$slots,"icon"),d(o.$slots,"default",i(c({label:e.label})),()=>[e.label&&!r(g)(e.label)?(b(),l("span",S,B(e.label),1)):y("",!0)]),d(o.$slots,"icon-after")],8,$)])],16,q))}});export{D as default};
